# ReviewLens AI — SaaS Landing Page Specification
...
> **Deployment Target:** Separate Next.js 14 repo or /apps/landing monorepo directory. Deploy to Vercel. Target domain: reviewlens.ai (main app moves to app.reviewlens.ai).
...
| --- | --- | --- |
| Display / Hero H1 | Instrument Serif | Google Fonts. Editorial precision without Space Grotesk cliche. |
...
White background. 2x3 grid of feature cards.
...
| components/landing/FeatureGrid.tsx | 2x3 feature card grid |
...
- **OG image:** 1200x630px — hero layout with the UI demo screenshot
